export interface Env {
  ...
  // DocuSign
  NEXT_PUBLIC_DOCUSIGN_RETURN_URL?: string;

  // Onramper
  NEXT_PUBLIC_ONRAMPER_API_KEY?: string;
  NEXT_PUBLIC_ONRAMPER_BASE_URL?: string;
  NEXT_PUBLIC_FRONTEND_URL?: string;

  // Blockchain / Wallet
  NEXT_PUBLIC_YIELDZ_TOKEN_ADDRESS?: string;
  NEXT_PUBLIC_VAULT_ADDRESS?: string;
  NEXT_PUBLIC_BUY_STABLE_COIN_ORDER_PROCESSOR?: string;
}
