export const paths = {
  ...
  auth: {
    custom: {
      signIn: '/auth/custom/sign-options',
      resetPassword: '/auth/custom/reset-password',
      otpVerification: '/auth/custom/verify-code',
      totpVerification: '/auth/custom/totp-authenticator',
      twoFactorAuthentication: '/auth/custom/2fa-authentication',
      verifyPhone: '/auth/custom/verify-phone',
      verifyCode: {
        email: '/auth/custom/verify-code/EMAIL',
        sms: '/auth/custom/verify-code/SMS',
        totp: '/auth/custom/verify-code/TOTP',
      },
      enablePasskey: '/auth/custom/passkey',
    },
    auth0: {
  ...
  dashboard: {
    ...
    tokensDetails: (tokenName: string) => `/dashboard/tokens/${tokenName}`,
    tokenCategories: '/dashboard/tokens/categories',
    tokenListCategories: (categoryId: string) => `/dashboard/tokens/categories/${categoryId}`,
    yldzsToken: '/dashboard/tokens/yldzs-token',
