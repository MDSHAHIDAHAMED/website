...
export function TextEditorToolbar({ editor }: Readonly<TextEditorToolbarProps>): React.JSX.Element {
            ...
            <Select
              onChange={(event: SelectChangeEvent) => {
                ...
                if (value.startsWith('h')) {
                  const level = Number.parseInt(value.replace('h', ''), 10) as HeadlingLevel;
