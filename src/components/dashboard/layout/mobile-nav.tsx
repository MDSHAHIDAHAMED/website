...
export function MobileNav({ items = [], open, onClose }: Readonly<MobileNavProps>): React.JSX.Element {
...
function renderNavItems({
  ...
  const children = items.reduce((acc: React.ReactNode[], curr: NavItemConfig): React.ReactNode[] => {
    ...
    const forceOpen = childItems
      ? childItems.some((childItem) => Boolean(childItem.href && pathname.startsWith(childItem.href)))
      : false;
