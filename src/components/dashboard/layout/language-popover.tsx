...
export function LanguagePopover({ anchorEl, onClose, open = false }: Readonly<LanguagePopoverProps>): React.JSX.Element {
  ...
  const handleChange = React.useCallback(
    async (language: Language): Promise<void> => {
      ...
      showSuccessToast('language-changed', t('common:languageChanged'));
      router.refresh();
    },
