...
export function Subscriptions({ subscriptions }: Readonly<SubscriptionsProps>): React.JSX.Element {
  return (
    <Card>
      <CardHeader
        avatar={
...
function SubscriptionItem({ subscription }: Readonly<{ subscription: Subscription }>): React.JSX.Element {
  const { label, color } = (
    {
